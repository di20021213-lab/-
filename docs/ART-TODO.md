...
Коровник закрыт: чёрно-пёстрая и бело-красная — в плитке не спутать.
Пятна у симментальской вышли ярче, чем у настоящей породы, скорее
...
Из пятнадцати кормов осталась одна дыра.

| Готово | Файл | Что это |
|:---:|---|---|
| ✅ | `feed-fish.png` | Рыбка, корм для кота |
| ✅ | `feed-vitamin.png` | Витаминная добавка |
| ✅ | `feed-navoz.png` | Перепревший навоз — был доской из набора реквизита |
| ✅ | `feed-torf.png` | Торфяной субстрат — был доской |
| ✅ | `feed-univer.png` | Комбикорм универсальный — был лавкой |
|  | `feed-bone.png` | Косточка, корм для собаки — пока 🦴 эмодзи |
